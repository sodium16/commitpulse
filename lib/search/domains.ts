...
export const SEARCH_DOMAINS: SearchableDomain[] = [
  ...
  },
  {
    id: 'faq',
    title: 'FAQ',
    description: 'Frequently asked questions about CommitPulse',
    href: '/faq',
  ...
  },
  {
    ...
    description: 'Rules and expectations for contributing to CommitPulse',
    href: '/guidelines',
    keywords: ['contributing', 'rules', 'gssoc', 'pr', 'conduct'],
    category: 'Community',
  },
  {
    id: 'support',
    title: 'Support',
    description: 'Get help, report bugs, or contact the CommitPulse team',
    href: '/support',
    keywords: ['help', 'contact', 'bug', 'issue', 'email'],
    category: 'Docs',
  },
  {
    id: 'github-repo',
