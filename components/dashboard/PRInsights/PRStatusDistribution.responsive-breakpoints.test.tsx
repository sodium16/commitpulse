...
// Prevent responsive charting libraries (like Recharts) from crashing during resize events
...
type ComponentProps = React.ComponentProps<typeof PRStatusDistribution>;
type PRInsightData = ComponentProps['data'];

describe('PRStatusDistribution Responsive Multi-device Columns & Mobile Viewport Layouts', () => {
  // Use 'as unknown as PRInsightData' to safely mock the required fields without triggering missing property errors or ESLint 'any' rules
  ...
  it('1. mocks standard mobile-width media coordinates (e.g. 375px wide viewports)', () => {
    ...
    const { container } = render(<PRStatusDistribution {...mockProps} />);
